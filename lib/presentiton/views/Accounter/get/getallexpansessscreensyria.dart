...
class getAllExpansessSyria extends StatelessWidget {
  getAllExpansessSyria({super.key});
            ...
            children: [
              ...
              onPress: () {
                ...
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => ExpansesScreen(nameExpanses: 'sy',)));
              },
                              ...
                              title:
                                ...
                                listener: (context, state) {
                                  if (state is SearchExpansessSucState) {
                                    ...
                                    Fluttertoast.showToast(msg: 'No Expensess');
                                  }
                                },
                ...
                if (state is GetAllIncomeLoadingState) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return cubit.expansessModel[index].type_value == 'sy'
                            ? Padding(
                                padding:
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'TotalSyria : ${cubit.total_expenses_syria.toString()}',
                              style: TextStyle(
                                  color: Colors.green,
                                  fontSize: 20,
                            ...
                            Text(
                              'Total : ${cubit.total_expenses.toString()}',
                              style: TextStyle(
                                  color: Colors.green,
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold),
